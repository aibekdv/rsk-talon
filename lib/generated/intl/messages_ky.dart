...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(reHour, reMin) => "Калды: ${reHour} с ${reMin} м";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "seleckservis":
            MessageLookupByLibrary.simpleMessage("Кызматты тандаңыз"),
        "selectCity": MessageLookupByLibrary.simpleMessage("Шаарды танданыз"),
        "selectLanguageText": MessageLookupByLibrary.simpleMessage(
            "Сураныч, интерфейс тилин тандаңыз."),
        "selectTime": MessageLookupByLibrary.simpleMessage("Убакытты тандоо"),
        "selectbranch":
        ...
        "yournumber": MessageLookupByLibrary.simpleMessage("Сиздин номер")
      };
}
